...
export declare function getCommitData(octokit: CustomOctokit, ref: string, owner?: string, repo?: string): Promise<import("@octokit/types").OctokitResponse<{
    url: string;
    sha: string;
    node_id: string;
    html_url: string;
...
export declare function getPullRequestIntroducingCommit(octokit: CustomOctokit, sha: string, owner?: string, repo?: string): Promise<import("@octokit/types").OctokitResponse<{
    url: string;
    id: number;
    node_id: string;
    html_url: string;
